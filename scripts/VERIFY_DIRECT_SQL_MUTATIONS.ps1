...
foreach($x in @('Mutation Path','focusedMutationPath','R15 production active-active')){
 if(-not $ui.Contains($x)){throw ('R15 UI invariant eksik: '+$x)}
}
Write-Host 'PASS: R15 Direct SQL Mutation Core Cutover statik kalite kapısı.'
