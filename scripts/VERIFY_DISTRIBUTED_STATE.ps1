...
if(-not $console.Contains('optimistic state version conflict')){throw 'R11 UI distributed-state açıklaması eksik.'}
...
Write-Host 'PASS: R11 Distributed State Engine + Active/Active Control Plane statik kalite kapısı.'
