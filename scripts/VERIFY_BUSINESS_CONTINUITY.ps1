...
foreach($x in @('BusinessContinuityPage','/api/v1/admin/business-continuity','Disaster Simulation','disasterSimulation','recoveryDag')){
 if(-not $ui.Contains($x)){throw ('R23 React structural/safety invariant eksik: '+$x)}
}
Write-Host 'PASS: R23 Business Continuity Command Center behavior + React structure gate.'
